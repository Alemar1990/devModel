...
print(eda.statistical_test(test='normality', alpha=0.01, cols=['Age'], analysis_indv=False))
...
#print(eda.statistical_test(test='anova', alpha=0.01, cols=None, analysis_indv=False, group=None, subgroups=None, feature_interest=None))